...
public class EngineBlock extends Block implements Engine, BlockMass {
    ...
    public EngineBlock(Properties properties, int tier, Supplier<GTRecipeType> recipeType,
                       @Nullable MutableComponent lore) {
        super(properties);
        this.tier = tier;
    ...
    public static NonNullFunction<Properties, EngineBlock> factory(int tier, Supplier<GTRecipeType> recipeType,
                                                                   @Nullable MutableComponent lore) {
