...
public class RRLang {
    public static final RRRegistrate.Translatable TOOLTIP_TIER =
            REGISTRATE.addRawLangTemplate("realrocket.rocket.tier", "Tier: %s", c -> c.withStyle(ChatFormatting.WHITE));

    public static final RRRegistrate.Translatable THRUST =
            REGISTRATE.addRawLangTemplate("realrocket.recipe.thrust", "Thrust: %sN", c -> c);

    public static final MutableComponent CANT_MIX_ENGINES =
            REGISTRATE.addRawLang("realrocket.rocket.cant_mix_engines", "Mixing engine types in one rocket is not allowed");
    public static final MutableComponent MULTIPLE_FLIGHT_COMPUTERS =
            REGISTRATE.addRawLang("realrocket.rocket.multiple_flight_computers", "A rocket cannot have multiple flight computers");
