...
public class Moon {
    ...
    public static final TagKey<Block> MOON_ORE_REPLACEABLES = TagKey.create(Registries.BLOCK,
            RealRocket.id("moon_ore_replaceables"));
        ...
        REGISTRATE.addOreVein("ilmenite_vein_moon", vein -> vein
                ...
                .layeredVeinGenerator(gen -> gen
                        .withLayerPattern(() -> GTLayerPattern.builder(MOON_ORE_RULES)
                                ...
                                .layer(l -> l.weight(1).mat(GTMaterials.Olivine).mat(GTMaterials.PotassiumFeldspar)
                                        .size(1, 1))
                                .build())));
        ...
        REGISTRATE.addOreVein("monazite_vein_moon", vein -> vein
                ...
                .layeredVeinGenerator(gen -> gen
                        .withLayerPattern(() -> GTLayerPattern.builder(MOON_ORE_RULES)
                                ...
                                .layer(l -> l.weight(1).mat(GTMaterials.Neodymium).mat(GTMaterials.Bastnasite).size(1,
                                        1))
                                .build())));
