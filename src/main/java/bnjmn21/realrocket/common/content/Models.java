...
public class Models {
    ...
    public static NonNullBiConsumer<DataGenContext<Block, ? extends Block>, RegistrateBlockstateProvider> randomRotated(ResourceLocation texture) {
        return (ctx, prov) -> {
    ...
    public static void simpleBlockWithExistingModel(DataGenContext<Block, ? extends Block> ctx,
                                                    RegistrateBlockstateProvider prov) {
