...
public interface FuelType {
    ...
    LiquidFuel OXIDIZER = new LiquidFuel(RRTags.ROCKET_FUEL_OXIDIZER,
            RRTags.OXIDIZER_LANG.copy().withStyle(ChatFormatting.DARK_AQUA));
    LiquidFuel PROPELLANT = new LiquidFuel(RRTags.ROCKET_FUEL_PROPELLANT,
            RRTags.PROPELLANT_LANG.copy().withStyle(ChatFormatting.RED));
