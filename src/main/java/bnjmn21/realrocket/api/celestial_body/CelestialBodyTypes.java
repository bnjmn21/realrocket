...
public class CelestialBodyTypes {
     ...
     * @param cosmicRadiationOnSurface additional radiation, scales with skylight, that means no radiation at night or
     *                                 in caves
    ...
    public record Planet(
        ...
        public static final MapCodec<Planet> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
                ...
                Codec.FLOAT.fieldOf("gravity").forGetter(Planet::gravity)).apply(instance, Planet::new));
        public static final CelestialBodyTypeCodec CODEC = new CelestialBodyTypeCodec(
                KeyDispatchDataCodec.of(MAP_CODEC).codec());
    ...
    public record Star(
        ...
        public static final MapCodec<Star> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
                ...
                Distance.CODEC.fieldOf("radius").forGetter(Star::radius)).apply(instance, Star::new));
        public static final CelestialBodyTypeCodec CODEC = new CelestialBodyTypeCodec(
                KeyDispatchDataCodec.of(MAP_CODEC).codec());
    ...
    public static void init() {
        ModLoader.get().postEvent(
                new GTCEuAPI.RegisterEvent<>(RRRegistries.CELESTIAL_BODY_TYPES, CelestialBodyTypeCodec.class));
        register();
