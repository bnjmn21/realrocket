...
public record CelestialBody(
    ...
    public static final Codec<CelestialBody> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Orbit.CODEC.optionalFieldOf("orbit").forGetter(CelestialBody::orbit)).apply(instance, CelestialBody::new));
     ...
     * @param angle     in radians, for map view, determines the angle of ellipse that describes the orbit. Can be left
     *                  as 0 for most orbits
     */
    public record Orbit(
        ...
        public static final Codec<Orbit> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                ...
                Codec.DOUBLE.fieldOf("angle").orElse(0.0).forGetter(Orbit::angle)).apply(instance, Orbit::new));
    }
}
